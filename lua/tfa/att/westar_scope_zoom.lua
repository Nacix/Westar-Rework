...
ATTACHMENT.Description = {TFA.Attachments.Colors["="], "2-8x adjustable zoom", TFA.Attachments.Colors["-"], "20% higher zoom time", TFA.Attachments.Colors["-"], "10% slower aimed walking"}
...
function ATTACHMENT:Attach(wep)
    ...
    wep.RTCode = function(myself, rt, scrw, scrh)
        ...
        if myret ~= Material(wep.ScopeVariant) then
            myret = Material(wep.ScopeVariant)
        end
